...
public class MainActivity extends Activity {
     ...
     */
    String SENDER_ID = "senderID-must-be-replace";
    823417256809
    /**
    ...
    private void sendRegistrationIdToBackend() {
        Log.i(this.getClass().getName(), "calling sendRegistrationIdToBackend");
    ...
    public class sendIdOnOverServer extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url = "http://phpgcm-buec.rhcloud.com/GCM.php?" + "&regID="+ regid;
                Log.i("Send URL:", url);
